    ...
    <div class="container">
        <div class="menu">
            <div class="cd-dropdown-wrapper">
                <a class="cd-dropdown-trigger" href="/storeCategories">store categories</a>
        ...
        <div class="move-text">
            ...
            <script type="text/javascript" src="{{asset('public/frontEnd/js/jquery.marquee.min.js')}}"></script>
            <script>
