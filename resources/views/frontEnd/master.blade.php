...
<link href="{{asset('frontEnd/css/menu.css')}}" rel="stylesheet" type="text/css" media="all" /> <!-- menu style --> 
<link href="{{asset('frontEnd/css/ken-burns.css')}}" rel="stylesheet" type="text/css" media="all" /> <!-- banner slider --> 
<link href="{{asset('frontEnd/css/animate.min.css')}} " rel="stylesheet" type="text/css" media="all" /> 
<link href="{{asset('frontEnd/css/owl.carousel.css')}}" rel="stylesheet" type="text/css" media="all"> <!-- carousel slider -->  
<!-- //Custom Theme files -->
<!-- font-awesome icons -->
...
<script src="{{asset('frontEnd/js/jquery-scrolltofixed-min.js')}}" type="text/javascript"></script>
<script>
    $(document).ready(function() {
...
<body>
	...
	<!-- //countdown.js -->
	<!-- menu js aim -->
	<script src="{{asset('frontEnd/js/jquery.menu-aim.js')}}"> </script>
